...
ShelbyGtWeb::Application.configure do
  ...
  config.assets.precompile = %w(common.js deferred.js landing.js seovideo.js shelby.js shelbify.js extension/includes.js mobile.js png.css print.css screen.css landing.css facebook.css seovideo.css extension.css mobile.css)
