...
ShelbyGtWeb::Application.configure do
  ...
  config.assets.precompile = %w(common.js deferred.js gate.js shelby.js shelbify.js radar.js mobile.js png.css print.css screen.css seovideo.css radar.css mobile.css)
