...
ShelbyGtWeb::Application.configure do
  ...
  config.assets.precompile = %w(common.js deferred.js landing.js shelby.js shelbify.js extension/includes.js mobile.js png.css print.css screen.css landing.css facebook-genius.css seovideo.css extension.css mobile.css)
