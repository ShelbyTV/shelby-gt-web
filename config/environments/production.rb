...
ShelbyGtWeb::Application.configure do
  ...
  config.assets.precompile = %w(*.eot *.woff *.ttf *.svg *.gif *.jpg *.jpeg *.png common.js deferred.js landing.js radar.js seovideo.js shares.js shares/shares_enabled.js shelby.js shelbify.js extension/includes.js mobile.js turbo.js experience.js signup.js zeddmore.js png.css print.css screen.css landing.css seovideo.css extension.css experience.css mobile.css radar.css signup.css zeddmore.css)
