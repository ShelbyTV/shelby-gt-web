...
ShelbyGtWeb::Application.configure do
  ...
  config.assets.precompile = %w(common.js deferred.js gate.js seovideo.js shelby.js shelbify.js extension/includes.js mobile.js png.css print.css screen.css seovideo.css extension.css mobile.css)
