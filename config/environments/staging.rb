...
ShelbyGtWeb::Application.configure do
  ...
  config.assets.precompile = %w(*.eot *.woff *.ttf *.svg *.gif *.jpg *.jpeg *.png common.js deferred.js landing.js seovideo.js shares.js shares/shares_enabled.js shelby.js shelbify.js extension/includes.js mobile.js turbo.js experience.js signup.js radar.js zeddmore.js png.css print.css screen.css landing.css seovideo.css extension.css experience.css mobile.css signup.css radar.css zeddmore.css)
