...
ShelbyGtWeb::Application.configure do
  ...
  config.assets.precompile = %w(*.eot *.woff *.ttf *.svg *.gif *.jpg *.jpeg *.png common.js deferred.js get_started.js landing.js seovideo.js shares.js shares/shares_enabled.js shelby.js shelbify.js mobile.js turbo.js experience.js signup.js radar.js png.css print.css screen.css landing.css seovideo.css experience.css get_started.css mobile.css signup.css radar.css)
