libs.shelbyGT.AppRouter = Backbone.Router.extend({
  ...
  initDynamic : function(url){
    ...
    shelby.models.playbackEventControllerModel = new libs.shelbyGT.PlaybackEventControllerModel();
    ...
    shelby.collections.eventfulEventCollection = new libs.shelbyGT.EventfulEventCollection();
