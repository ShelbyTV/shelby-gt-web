var Browser = {
    ...
    isFacebook: function() {
        if (App.getCookie("facebook_app") === "true") {
            return true;
        } else {
            return false;
        }
    ...
    isTablet: function() {
        if (navigator.platform.match(/^(iPad|Kindle)$/)) {
            return true;
        } else {
            return false;
        }
    ...
    isMobile: function() {
        if (navigator.platform.match(/^(iPad|iPod|iPhone|Android)$/)) {
            return true;
        } else {
            return false;
        }
    ...
    isAmazonWebApp: function() {
        if (navigator.userAgent.match(/(AmazonWebAppPlatform|Kindle)/)) {
            return true;
        } else {
            return false;
        }
