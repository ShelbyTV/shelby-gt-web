...
libs.shelbyGT.PersistentVideoInfoView = Support.CompositeView.extend({
  ...
  events : {
    "click .persistent_video_info--current-frame  .js-roll-frame"                 : "_requestCurrentFrameRollView",
    "click .persistent_video_info--next-frame     .js-roll-frame"                 : "_requestNextFrameRollView",
    "click .persistent_video_info--current-frame  .js-share-frame"                : "_requestCurrentFrameShareView",
    "click .persistent_video_info--next-frame     .js-share-frame"                : "_requestNextFrameShareView",
    "click .persistent_video_info--current-frame  .js-queue-frame:not(.queued)"   : "_queueCurrentFrame",
    "click .persistent_video_info--next-frame     .js-queue-frame:not(.queued)"   : "_queueNextFrame"
  },
   ...
   * Button events
   *************************************************************/
  _requestCurrentFrameRollView : function(){ this._requestFrameRollView(this._currentFrame); },
  _requestNextFrameRollView : function(){ this._requestFrameRollView(this._nextFrame); },
  ...
  _requestCurrentFrameShareView : function(){ this._requestFrameShareView(this._currentFrame); },
  _requestNextFrameShareView : function(){ this._requestFrameShareView(this._nextFrame); },
  ...
  _queueCurrentFrame : function(el){ this._queueFrame(this._currentFrame, el); },
  _queueNextFrame : function(el){ this._queueFrame(this._nextFrame, el); },
