libs.shelbyGT.FrameGroupView = libs.shelbyGT.ActiveHighlightListItemView.extend({
  ...
  events : {
    ...
    "click .js-event-manager"               : "requestEventManagerView"
  },
  ...
  requestEventManagerView : function(e) {
    e.preventDefault();

    console.log('requesting event manager');

    this.options.guideOverlayModel.switchOrHideOverlay(libs.shelbyGT.GuideOverlayType.events,
      this.model.getFirstFrame());
  },
