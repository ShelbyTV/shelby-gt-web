module ApplicationHelper
  ...
  def check_for_signed_in_user
    if user_signed_in?
      ...
      if signed_in_user['user_type'] and (signed_in_user['user_type'] == Settings::Application.user_type.anonymous)
        signed_in_user['nickname'] = 'Xxxxxxx'
        signed_in_user['name'] = 'Xxx Xxxx'
